...
public class BusRouteServiceTest {
	...
	public void isDirect_false_depSid_equal_arrSid() {
		boolean direct = busRouteService.isDirect(3, 3);// externalize data
		Assert.assertFalse(direct);
	}

	@Test
	public void isDirect_false_depSid_null_arrSid_null() {
		boolean direct = busRouteService.isDirect(null, null);
		Assert.assertFalse(direct);
	}
	...
	public void isDirect_true() {
		...
		boolean direct = busRouteService.isDirect(2, 4);
	...
	public void isDirect_false() {
		...
		boolean direct = busRouteService.isDirect(2, 3);
		Assert.assertFalse(direct);
	}
